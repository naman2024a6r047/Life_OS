...
export default function ExamSetup({ onComplete }) {
    ...
    return (
        <div className="min-h-screen bg-[#090A0F] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="glass-panel max-w-2xl w-full p-8 md:p-12 rounded-3xl border border-slate-700 shadow-2xl relative z-10">
                ...
                <h1 className="text-4xl font-extrabold mb-4 text-white">Enable Exam Mode</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <button type="button" className="w-full bg-slate-900/50 hover:bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-cyan-400 flex items-center justify-center gap-2 transition-colors">
                    ...
                    <div className="pt-6 border-t border-slate-800 flex justify-end gap-4">
                        <button 
                            ...
                            className="px-6 py-3 rounded-xl border border-slate-700 hover:bg-slate-800 text-slate-300 font-semibold transition"
                        >
                            Cancel
                        </button>
                        <button 
                            type="submit" 
                            disabled={submitting}
                            className="px-8 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold rounded-xl transition flex items-center gap-2 shadow-lg shadow-cyan-600/20 disabled:opacity-50"
                        >
