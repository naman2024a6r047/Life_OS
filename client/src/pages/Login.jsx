        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            >
                ...
                <div className="relative flex py-2 items-center mb-6">
                    ...
                    <span className="flex-shrink mx-4 text-xs text-textSecondary uppercase tracking-wider">or sign in with email</span>
                    <div className="flex-grow border-t border-white/10"></div>
                </div>
                ...
                <p className="mt-6 text-center text-sm text-textSecondary">
                    Don't have an account? <Link to="/register" className="text-primary hover:text-primary-light font-medium">Create one</Link>
                </p>
            </motion.div>
        </div>
    );
